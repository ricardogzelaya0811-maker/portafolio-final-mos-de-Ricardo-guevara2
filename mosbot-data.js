...
const MOSBOT_MISSIONS = [
  ...
  {id:'wd12',type:'word',title:'BUSCARV (VLOOKUP)',desc:'Búsqueda vertical en tablas de datos.',
   q:'¿Qué opción permite combinar celdas dentro de una tabla en Word?',opts:['Clic derecho > Combinar celdas','Inicio > Combinar','Insertar > Combinar','Diseño > Combinar'],ans:0},
  {id:'wd13',type:'word',title:'SUMAR.SI (SUMIF)',desc:'Suma condicional de rangos.',
   q:'¿Cómo se aplica un estilo de tabla predefinido en Word?',opts:['Seleccionar tabla > Diseño > Estilos de tabla','Insertar > Estilo','Inicio > Formato','Referencias > Estilos'],ans:0},
  {id:'wd14',type:'word',title:'Formato Condicional',desc:'Resaltar celdas según reglas.',
   q:'¿Dónde se encuentra la opción para ajustar automáticamente el ancho de columna en una tabla de Word?',opts:['Diseño de tabla > Ajustar ancho automático','Inicio > Tamaño','Insertar > Ajustar','Vista > Ajustar'],ans:0},
  ...
  {id:'wd16',type:'word',title:'Gráficos en Excel',desc:'Visualización de datos con gráficos.',
   q:'¿Cómo conviertes texto separado por tabulaciones en una tabla en Word?',opts:['Insertar > Tabla > Convertir texto a tabla','Inicio > Convertir','Diseño > Texto a tabla','Referencias > Texto a tabla'],ans:0},
  {id:'wd17',type:'word',title:'Función SI (IF)',desc:'Evalúa condiciones lógicas.',
   q:'¿Qué comando se usa para dividir una celda en varias en una tabla de Word?',opts:['Diseño > Dividir celdas','Insertar > Dividir','Inicio > Dividir','Referencias > Dividir'],ans:0},
  {id:'wd18',type:'word',title:'CONTAR.SI (COUNTIF)',desc:'Cuenta celdas que cumplen un criterio.',
   q:'¿Cómo se repite la fila de encabezado de una tabla al pasar de página en Word?',opts:['Propiedades de tabla > Repetir fila de encabezado','Insertar > Repetir encabezado','Diseño > Página > Repetir','Inicio > Repetir'],ans:0},
  ...
  {id:'wd20',type:'word',title:'Proteger Hojas',desc:'Seguridad y protección de hojas de cálculo.',
   q:'¿Cómo se protege o restringe la edición de una tabla dentro de un documento Word?',opts:['Revisar > Restringir edición','Archivo > Proteger documento','Inicio > Proteger','Vista > Proteger'],ans:0},
  // ── WORD MISSIONS (10) ──
  {id:'wd1',type:'word',title:'Formato de Texto',desc:'Negrita, cursiva, subrayado y estilos.',
    q:'¿Cómo insertas una fila encima de la fila seleccionada en una tabla de Word?',opts:['Ctrl+B','Ctrl+N','Ctrl+G','Ctrl+A'],ans:0},
  {id:'wd2',type:'word',title:'Estilos y Temas',desc:'Aplicar estilos predefinidos a documentos.',
    q:'¿Cómo aplicas sombreado o color de fondo a una celda o fila de tabla en Word?',opts:['Pestaña Inicio > Estilos','Pestaña Diseño','Pestaña Insertar','Pestaña Referencias'],ans:0},
  ...
  {id:'wd4',type:'word',title:'Encabezados y Pies',desc:'Configurar encabezados y pies de página.',
    q:'¿Cómo conviertes una tabla en texto en Word?',opts:['Insertar > Encabezado','Inicio > Encabezado','Diseño > Encabezado','Vista > Encabezado'],ans:0},
  {id:'wd5',type:'word',title:'Saltos de Página',desc:'Controlar la paginación del documento.',
    q:'¿Qué opción permite ordenar las filas de una tabla por una columna en Word?',opts:['Ctrl+Enter','Ctrl+Shift+Enter','Alt+Enter','Ctrl+P'],ans:0},
  {id:'wd6',type:'word',title:'Listas y Viñetas',desc:'Organizar información con listas.',
    q:'¿Cómo ajustas la distribución vertical del texto dentro de las celdas de una tabla?',opts:['Inicio > Párrafo > Lista multinivel','Insertar > Lista','Diseño > Lista','Referencias > Lista'],ans:0},
  ...
  {id:'wd8',type:'word',title:'Comentarios y Revisión',desc:'Colaborar con comentarios en documentos.',
    q:'¿Cómo agregas un comentario a una celda específica de una tabla en Word?',opts:['Revisar > Nuevo comentario','Insertar > Comentario','Inicio > Comentario','Vista > Comentario'],ans:0},
  {id:'wd9',type:'word',title:'Tabla de Contenido',desc:'Generar tabla de contenido automática.',
    q:'¿Qué opción permite repetir automáticamente la fila de encabezado de una tabla en cada nueva página?',opts:['Referencias > Tabla de contenido','Insertar > Tabla de contenido','Inicio > Índice','Diseño > Contenido'],ans:0},
  {id:'wd10',type:'word',title:'Combinar Correspondencia',desc:'Crear documentos personalizados en masa.',
    q:'¿Cómo insertas una fórmula simple (por ejemplo, suma) dentro de una celda de tabla en Word?',opts:['Correspondencia','Insertar','Inicio','Revisar'],ans:0}
];
